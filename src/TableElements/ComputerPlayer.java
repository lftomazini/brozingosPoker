...
public class ComputerPlayer extends Player{
    ...
    /**
     * When a bet is made on the table, it tells what the player 
     * to do, depending on different situations
    ...
    /**
     * When no bet is made on the table, it tells what the player 
     * to do, depending on different situations
     */
